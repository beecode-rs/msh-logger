...
import { LoggerStrategyConsole } from '#/logger-strategy/console/index'
import { ConsoleLogStrategyMock } from '#/logger-strategy/console/log-strategy/__mocks__/console-log-strategy-mock'
